...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Image'
        db.create_table(u'contacts_image', (
        ...
        db.send_create_signal(u'contacts', ['Image'])

        # Deleting field 'Post.img'
        db.delete_column(u'contacts_post', 'img')


    def backwards(self, orm):
        # Deleting model 'Image'
        db.delete_table(u'contacts_image')

        # Adding field 'Post.img'
        db.add_column(u'contacts_post', 'img',
