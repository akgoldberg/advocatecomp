...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.alum'
        db.add_column(u'contacts_contact', 'alum',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Contact.user'
        db.add_column(u'contacts_contact', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.alum'
        db.delete_column(u'contacts_contact', 'alum')

        # Deleting field 'Contact.user'
        db.delete_column(u'contacts_contact', 'user_id')
